    ...
    <div className="rounded-2xl overflow-hidden" style={{ border: `1.5px solid ${borderColor}`, background: "var(--bg-subtle)" }}>
      ...
      <div className="grid grid-cols-7 px-2 pb-3 gap-y-0.5">
        {cells.map((cell, i) => {
          ...
          else if (isBooked)                      { bg = "#FEF3C7"; textColor = "#D97706"; }
      ...
      {bookedDates && bookedDates.size > 0 && (
        <div className="flex items-center gap-4 px-4 pb-3">
          <div className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full inline-block" style={{ background: "#FEF3C7", border: "1.5px solid #D97706" }} />
            <span className="text-[10px]" style={{ color: "var(--fg-muted)" }}>Has booking</span>
          </div>
          <div className="flex items-center gap-1.5">
