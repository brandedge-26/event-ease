  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/vendor/general/dashboard/calendar" className="text-xs font-medium hover:underline" style={{ color: "var(--primary)" }}>
          Full view
        </Link>
      </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-4 lg:gap-6">
                  ...
                  <div key={b.id} className={`flex items-center justify-between py-3 ${i !== todayBookings.length - 1 ? "border-b border-[#F4F4F5]" : ""}`}>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs" style={{ color: "var(--fg-muted)" }}>{b.phone || "—"}</p>
                      </div>
                    </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-5 pt-5 pb-3">
              ...
              <Link href="/vendor/general/dashboard/bookings" className="text-xs font-medium hover:underline" style={{ color: "var(--primary)" }}>
                View all
              </Link>
            </div>
