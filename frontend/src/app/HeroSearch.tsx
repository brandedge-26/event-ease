      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
          ...
          <div className="flex items-center gap-3 px-5 py-4">
            ...
            <div className="flex-1 min-w-0 text-left">
              <p className="text-[10px] font-semibold uppercase tracking-wide mb-0.5" style={{ color: "#9CA3AF" }}>City</p>
              <CustomSelect
                value={city}
                onChange={setCity}
          ...
          <div className="flex items-center gap-3 px-5 py-4">
            ...
            <div className="flex-1 min-w-0 text-left">
              <p className="text-[10px] font-semibold uppercase tracking-wide mb-0.5" style={{ color: "#9CA3AF" }}>Venue Type</p>
              <CustomSelect
                value={type}
                onChange={setType}
        ...
        {/* Row 2 */}
        <div
          className="flex items-center gap-4 px-5 py-3 border-t border-gray-100 flex-wrap"
          style={{ background: "#FAFAFA", borderRadius: "0 0 1rem 1rem" }}
        >
          {/* Capacity — custom dropdown */}
