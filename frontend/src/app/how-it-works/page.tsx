        ...
        <div className="max-w-5xl mx-auto px-4 py-14 space-y-20">
          ...
          <section>
            ...
            <div className="mt-6 flex justify-center">
              <Link href="/vendor/onboarding"
                ...
                <img src="/logo/white_icon.png" alt="" width={15} height={15} className="shrink-0" />
                List Your Business
              </Link>
            </div>
          </section>
          ...
          <section className="rounded-2xl p-8 text-center" style={{ background: "linear-gradient(135deg, #FF3B6B 0%, #FF8FA3 100%)" }}>
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link href="/vendor/onboarding"
                className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold border-2 border-white text-white transition-opacity hover:opacity-80">
